                   ...
                   <form method="post" action="">
                    ...
                    <table> 
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td><input type="text" name="username" id="admin-username" value= "<?php echo session('username'); ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:<span>*</span></td>
                                <td>&nbsp;</td>
...
<!--<script src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/after/js/save.js"></script>-->
