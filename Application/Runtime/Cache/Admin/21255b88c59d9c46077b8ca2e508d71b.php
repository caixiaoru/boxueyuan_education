    ...
    <div class="col-md-12 column">
            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column">
                <ul class="breadcrumb">
                  <li><a href="/BOXUEYUANEND--double/index.php/Admin/Index/index">首页</a></li>
                  <li><a href="/BOXUEYUANEND--double/index.php/Admin/Teacher/teacher_all">名师管理</a></li>
                  <li class="active">所有名师</li>
                </ul>
              ...
              <form  action="/BOXUEYUANEND--double/index.php/Admin/Teacher/del" role="form" >
              <div class="row" id="add-del">                
                <div class="col-md-2 column"> 
                	  <button><a href="<?php echo U('Admin/Teacher/teacher_add');?>">添加名师</a></button>
		            </div>	       
		            <div class="col-md-2 column">
              ...
              <div class="row" id="admin-table" style="margin-left: 3%">         
                <table class="table" style="margin-left: 0%; border-spacing:0px;  ">
                  ...
                  <?php if(is_array($teacher)): $i = 0; $__LIST__ = $teacher;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><tr>
                    <td><input type="checkbox" name="id[]" value='<?php echo ($t["tid"]); ?>' id="checkbox1"/></td>
                    <td><?php echo ($t["tid"]); ?></td>
                    <td><?php echo ($t["username"]); ?></td>
                    <td><?php echo ($t["registertime"]); ?></td>
                    <td><?php echo ($t["lasttime"]); ?></td>
                    <td> <a href="/BOXUEYUANEND--double/index.php/Admin/Teacher/del/id/<?php echo ($t["tid"]); ?>">删除</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="/BOXUEYUANEND--double/index.php/Admin/Teacher/teacher_edit/id/<?php echo ($t["tid"]); ?>">编辑</a></td>
                    ...
                    <td> <a href="#">删除</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="teacher_edit.html">编辑</a></td>
                    </tr>-->
                  </tbody>
                </table>
              </div>
