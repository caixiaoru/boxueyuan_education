            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column">
                <ul class="breadcrumb">
                  ...
                  <li><a href="/BOXUEYUANEND1/index.php/Admin/User/user_all">名师管理</a></li>
                      ...
                      <tr>
                          <td>用户名称:<span>*</span></td>
                            ...
                            <tr>
                                <td>头&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;像:<span>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><img src="/BOXUEYUANEND1/Public/<?php echo ($user["img"]); ?>"  width="80px" height="80px"/><input type="file" name="img" id="admin-img"></td>
                            </tr>
