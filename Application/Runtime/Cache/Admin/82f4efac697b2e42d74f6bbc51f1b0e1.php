            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column">  
                <ul class="breadcrumb">
                  ...
                  <li><a href="/BOXUEYUANEND--double/index.php/Admin/admin/all">管理员管理</a></li>
                    ...
                    <form method="post" action="" enctype="multipart/form-data" role="form">
                        <table>
                            ...
                            <tr> 
                                <td>注册时间:<span>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><input type="text" name="administrator" id="admin-time" value="<?php echo date('Y-m-d H:i:s',time()); ?>"></td>
                            </tr>
