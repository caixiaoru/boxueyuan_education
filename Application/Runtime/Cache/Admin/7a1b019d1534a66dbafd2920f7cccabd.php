            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column"> 
                <ul class="breadcrumb">
                  ...
                  <li>
                     <a href="/BOXUEYUANEND1/index.php/Admin/video/video_all">视频管理</a>
                  </li>
                  <li class="active">
                    编辑视频
                  </li>
                ...
                <form action="/BOXUEYUANEND1/index.php/Admin/video/doEdit" method="post"  enctype="multipart/form-data">
