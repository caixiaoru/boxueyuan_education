            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column"> 
                <ul class="breadcrumb">
                  ...
                  <li><a href="/BOXUEYYUAN/a/a/BOXUEYUANEND/admin.php/Note/all">笔记管理</a></li>
                  <li class="active"> 
                    添加笔记
                  </li>
                </ul>
                <form role="form" action="/BOXUEYYUAN/a/a/BOXUEYUANEND/admin.php/Note/doAdd" method="post" enctype="multipart/form-data">
                  <table> 
