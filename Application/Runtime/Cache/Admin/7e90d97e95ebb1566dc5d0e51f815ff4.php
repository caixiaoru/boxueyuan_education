    ...
    <div class="col-md-12 column">
            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column" >
                <ul class="breadcrumb"> 
                  <li>
                     <a href="/BOXUEYUANEND--double/index.php/Admin/Index/index"><span class="glyphicon  glyphicon-home"></span> 首页</a>
                  </li>
                  <li>
                     <a href="/BOXUEYUANEND--double/index.php/Admin/video/video_all">视频管理</a>
                  </li>
                  <li class="active">
                    所有视频
                  </li> 
                ...
                <form action="/BOXUEYUANEND--double/index.php/Admin/Video/delete">
                <div class="row" id="add-del"> 
                <div class="col-md-2 column">
                     <button><a href="<?php echo U('Admin/video/video_add');?>">添加视频</a></button>
                  </div>           
                  <div class="col-md-2 column">
                  ...
                  <br>
                <table class="table" id="video_table" style="margin-left:30px;border-spacing: 0px;">
                  <thead>
                    <tr>
                      <th>
                  ...
                  <tbody>
                    <?php if(is_array($video)): $i = 0; $__LIST__ = $video;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$V): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td>
                        <a  href="delete/dataId/<?php echo ($V["vid"]); ?>">删除</a>/<a href="/BOXUEYUANEND--double/index.php/Admin/Video/video_edit/id/<?php echo ($V["vid"]); ?>">编辑</a>
