            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column">
                <ul class="breadcrumb">
                  ...
                  <li><a href="/BOXUEYUANEND1/index.php/Admin/Teacher/teacher_all">名师管理</a></li>
                  <li class="active">编辑名师</li>
                </ul>
                
              
                   <div class="row" id="admin-admin"><h2>编辑名师</h2></div>
                <div class="row">
                      ...
                      <tr>
                          <td>用户名称:<span>*</span></td>
                            ...
                            <tr>
                                <td>注册时间:<span>*</td>
                                <td>&nbsp;</td>
                                <td><input type="data" name="time" id="admin-time" value="<?php echo ($teacher["registertime"]); ?>" readonly></td>
                            </tr>

                            <tr>
                                <td>头&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;像:<span>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><img src="/BOXUEYUANEND1/Public/<?php echo ($teacher["img"]); ?>"  width="80px" height="80px"/><input type="file" name="img" id="admin-img"></td>
                            </tr>
