    ...
    <div class="col-md-12 column">
            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column"> 
                <ul class="breadcrumb">
                   <li>
                     <a href="/BOXUEYUANEND1/index.php/Admin/Index/index"><span class="glyphicon  glyphicon-home"></span> 首页</a>
                  </li> 
                  <li> 
                     <a href="/BOXUEYUANEND1/index.php/Admin/News/all">新闻管理</a>
                  </li>
                  <li class="active">
                    所有新闻 
                  </li>
                ...
                <form  action="/BOXUEYUANEND1/index.php/Admin/News/del" > 
                <div class="row" id="add-del">                
                  <div class="col-md-2 column">
                     <button><a href="<?php echo U('Admin/News/add');?>">添加新闻</a></button>
                  </div>           
                  <div class="col-md-2 column">
                ...
                <table class="table"  style="margin-left:-30px;border-spacing: 0px;">
                  <thead>
                    <tr>
                      <th>                      
                       <input name="checkall" type="checkbox" value="checkall" id="checkall"/>
                      </th>
                      <th>
                        ID
                      </th>
                  ...
                  <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newse): $mod = ($i % 2 );++$i;?><tr >
                    <td><input type="checkbox" name="id[]" value='<?php echo ($newse["id"]); ?>' id="checkbox1"/></td>
                    <td>
                        <?php echo ($newse["id"]); ?>
                      </td>
                      <td>
                        <?php echo ($newse["grade"]); ?>
                      </td>
                      <td>
                        <?php echo ($newse["course"]); ?>
                      </td>
                      
                      <td style="width:15%;">
                        <!--<?php echo (mb_substr($newse["title"],0,10,'utf-8')); ?>...-->
                        <?php echo ($newse["title"]); ?>
                      </td>
                       <td style="width:20%;">
                      
                      <?php echo (mb_substr($newse["summary"],0,70,'utf-8')); ?>...
                      </td>
                       <td>
                        <?php echo ($newse["name"]); ?>
                      </td>
                      ...
                      <td style="width:10%;">
                        <?php echo ($newse["addtime"]); ?>
                      </td>
                      </td>
                      <td style="width:10%;">
                        <?php echo ($newse["updatetime"]); ?>
                      </td>
                      </td>
                      <td>
                        <a href="/BOXUEYUANEND1/index.php/Admin/News/del/id/<?php echo ($newse["id"]); ?>">删除</a>/<a href="/BOXUEYUANEND1/index.php/Admin/News/edit/id/<?php echo ($newse["id"]); ?>">编辑</a>
                      </td>
