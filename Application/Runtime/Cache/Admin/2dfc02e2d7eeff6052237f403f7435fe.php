            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column">
                <ul class="breadcrumb">
                  ...
                  <li>
                     <a href="/BOXUEYYUAN/a/a/BOXUEYUANEND/admin.php/News/all">新闻管理</a> 
                  </li>
                  <li class="active">
                    添加新闻
                  </li>
                ...
                <form antion="" method="post">
                  <table>
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td><input type="text" name="title" id="newsname" ></td>
                            </tr>
                            ...
                            <tr>
                                <td>科目:<span></span></td>
                                <td>&nbsp;</td>
                                <td><input type="text" name="course" id="kemuname"></td>
                            </tr>
                                                     
                             <tr>
                                <td>摘要:<span>*</span></td>
                                <td>&nbsp;</td>
                                <td><input type="text" name="summary" id="kemuname"></td>
                            </tr>
                                   
                         <tr>
                                <td>发布人:<span></span></td>
                                <td>&nbsp;</td>
                                <td><input type="text" name="name" id="kemuname"></td>
                            </tr>
                             <tr>
                                <td>发布社:<span>*</span></td>
                                <td>&nbsp;</td>
                                <td><input type="text" name="from" id="kemuname"></td>
                            </tr>
