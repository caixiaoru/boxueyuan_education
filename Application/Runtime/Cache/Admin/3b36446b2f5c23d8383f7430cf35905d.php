    ...
    <div class="col-md-12 column">
            <nav class="navbar navbar-default" role="navigation">             
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               ...
               <a htef="#">当前用户：<?php echo session('username'); ?></a>
                  ...
                  <li>
                     <a href="/BOXUEYUANEND/index.php/Admin/Login/login">退出</a>
                  </li>
                </ul>
              </div>
            </nav>
            <div class="row clearfix">
              ...
              <div class="col-md-10 column">
                <ul class="breadcrumb">
                  <li><a href="/BOXUEYUANEND/index.php/Admin/Index/index">首页</a></li>
                  <li><a href="/BOXUEYUANEND/index.php/Admin/Book/book_all">资料管理</a></li>
                  <li class="active">编辑资料</li>
                </ul>
                
              
                   <div class="row" id="admin-admin"><h2>编辑资料</h2></div>
                <div class="row">
                   <form  action="/BOXUEYUANEND/index.php/Admin/Test/doEdit" method="post" enctype="multipart/form-data">
                       <table>
                           <tr>
                               <td>科&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目:<span>*</span></td>
                               <td>&nbsp;</td>
                               <td><input type="text" name="kemu" id="admin-username" value="<?php echo ($data["kemu"]); ?>"></td>
                           </tr>
                           <tr>
                               <td>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级:<span>*</span></td>
                               <td>&nbsp;</td>
                               <td><input type="text" name="grade" id="admin-password" value="<?php echo ($data["grade"]); ?>"></td>
                           </tr>
                           <tr>
                               <td>资料名称:<span>*</span></td>
                               <td>&nbsp;</td>
                               <td><input type="text" name="zname" id="admin-repassword" value="<?php echo ($data["zname"]); ?>"></td>
                           </tr>
                           <tr>
                               <td>摘要:<span>&nbsp;</span></td>
                               <td>&nbsp;</td>
                               <td><textarea rows="5" cols="30" name="zhaiyao"><?php echo ($data["zhaiyao"]); ?></textarea></td>
                           </tr>
                           <tr>
                               <td>资料内容:<span>&nbsp;</span></td>
                               <td>&nbsp;</td>
                               <td><textarea rows="10" cols="30" name="content"><?php echo ($data["content"]); ?></textarea></td>
                           </tr>
                           <tr>
