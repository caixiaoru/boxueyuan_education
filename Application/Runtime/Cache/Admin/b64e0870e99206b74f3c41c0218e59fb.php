            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column"> 
                <ul class="breadcrumb">
                  ...
                  <li><a href="/BOXUEYUANEND1/index.php/Admin/admin/all">管理员管理</a></li>
                  <li class="active">修改管理员信息</li>
                </ul>
                 <div class="row" id="admin-admin"><h2>编辑管理员信息</h2></div>
                
                <div class="row" id="admin-table">
                  <div class="row">
                 
                   <form method="post" action="">
                     <?php if(is_array($administrator)): $i = 0; $__LIST__ = $administrator;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$administrator): $mod = ($i % 2 );++$i;?><table>
                   
                      <tr>
                          <td>用户名称:<span>*</span></td>
                                <td>&nbsp;</td>
                                <td><input type="text" placeholder="administrator" name="username" value="<?php echo ($administrator["username"]); ?>" id="admin-username"></td>
                            </tr>
                            <tr>
                                <td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:<span>*</span></td>
                                <td>&nbsp;</td>
                                <td><input type="password" name="password" id="admin-password" value="<?php echo ($administrator["password"]); ?>"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td><input type="number" name="phone" value="<?php echo ($administrator["phone"]); ?>"id="admin-phone"></td>
                            </tr>
                            <tr>
                                <td>电子邮箱:<span>*</span></td>
                                <td>&nbsp;</td>
                                <td><input type="email" name="email" value="<?php echo ($administrator["email"]); ?>"id="admin-email"></td>
                            </tr>

                            <tr>
                                <td>注册时间:<span>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><input type="text" name="registertime" id="admin-time"value="<?php echo ($administrator["registertime"]); ?>"></td>
                            </tr>

                            <tr>
                                <td><button type="submit" name="submit" class="btn btn-info btn-default" id="save">保存</button></td>
                                <td>&nbsp;</td>
                                <td><button type="button" class="btn btn-info btn-default" id="cancle" onclick="history.back(-1)">取消</button></td>
                            </tr>
