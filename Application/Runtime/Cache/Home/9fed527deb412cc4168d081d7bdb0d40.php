...
<li><a class="scroll hvr-bounce-to-bottom " href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/About/about">关于我们<p style="text-align: center;">About</p></a></li>
	...
	<div class="container">
		...
		<div class="banner-info wow bounceInDown" data-wow-duration="1s" data-wow-delay="0s">
			<script src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/js/responsiveslides.min.js"></script>
			<script>
	...
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li>
					<a rel="nofollow" href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/English/english">数学</a> 
				</li>
				<li class="active">
					视频
				</li>
...
<div class="container">
	<div class="row" >
		<div class="col-xs-9 col-md-9 bcolor">
            ...
            <video src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/<?php echo ($data["address"]); ?>" controls="controls" loop="true" id="video" style="width:100%;height:500px;"></video>
		</div>
		<div class="col-xs-3 col-md-3 bcolor">
			<h3><img src='/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/images/2.png'>推荐课程</h3>
			<ul>
			    <?php if(is_array($tuijian)): $i = 0; $__LIST__ = $tuijian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tuijian): $mod = ($i % 2 );++$i;?><li>
					<a href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/English/newvideo/id/<?php echo ($tuijian["vid"]); ?>" style="color:white"><?php echo ($tuijian["videoname"]); ?></a>
...
<div class="row">
	...
	<div class="col-md-9">
	<div class="row">
	<form action="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Chinese/addliuyan" method="post">
	...
	<!-- <div  id="new-video"><button type="submit" class="btn btn-primary" id="btn" value="<?php echo ($data["vid"]); ?>"><a href="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/shipin.docx" >下载文档</a></button></div> -->
	</div>
		...
		<div class="col-md-12 all">
            ...
            <?php if(is_array($liuyan)): $i = 0; $__LIST__ = $liuyan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$liuyan): $mod = ($i % 2 );++$i;?><div class="row bian">
				...
				<div class="col-md-2 "><img src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/<?php echo ($liuyan["img"]); ?>" alt="" width="100%"></div>
				...
				<div class="row col-md-12 zan">
					<div class="col-md-2"></div><div class="col-md-9">赞&nbsp;&nbsp;<img src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/images/thumbs-up.png" alt="" width="2.5%" class="we">&nbsp;&nbsp;<span>10</span></div>
	...
	<div class="col-md-3">
	    <div class="col-md-12 bian1" style="text-align:center">
			<img src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/<?php echo ($teacher["img"]); ?>" alt="" style="width:100px;height:40x;padding-top:10px;">
			<dl class="right-dl">
				<dt>教师姓名：</dt>
...
document.getElementById("btn").onclick = function() {
	...
	//alert(id);
	xhr.open('get', '/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Chinese/downjiaocai?downid='+id, true);
	xhr.send();
}
