	...
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li>
					<a rel="nofollow" href="/BOXUEYUANEND--double/index.php/Home/GaoKao/gaokaozhuanti">高考专题</a> <span class="divider"></span>
				</li>
				<li class="active">
					状元笔记
				</li>
...
<!--内容-->
   <div class="container">
    <div class="row wow wow zoomIn" data-wow-duration="1s" data-wow-delay="0s" id="note_id">
    	    <div class="col-md-1 column"></div>
<?php if(is_array($note)): $i = 0; $__LIST__ = $note;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$note): $mod = ($i % 2 );++$i;?><div class="col-md-10 column">
      <h2 class="text-center">
        理综高考状元<?php echo ($note["name"]); ?>笔记
      </h2>
      <br/>
      <h3 class="text-center">
        ...
        <p style="text-align:center;font-size:0.5em">时间：<?php echo ($note["addtime"]); ?>&nbsp;&nbsp;&nbsp;来源：博学苑梦之队&nbsp;&nbsp;&nbsp;作者：<?php echo ($note["autor"]); ?></p>
         <br/>
      <p>
...
<div class="row">
     	...
     	<div class="col-md-10">
     		<div class="col-md-6">上一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Note/note/Wid/<?php echo ($front["wid"]); ?>"><?php echo ($front["title"]); ?></a></div>
     		<div class="col-md-6">下一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Note/note/Wid/<?php echo ($after["wid"]); ?>"><?php echo ($after["title"]); ?></a></div>
     	</div>
     	<div class="col-md-2"></div>
     </div>
<br/>
