							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								<nav class="cl-effect-1">
									<ul class="nav navbar-nav ">
										...
										<li id="act-Home"><a class="scroll hvr-bounce-to-bottom active" href="/BOXUEYUANEND--double/index.php/Home/Hot/hot">热点资讯 <p style="text-align: center;">News</p></a></li>
...
<div class="container">
	 ...
	 <div class="row "><h3 style="text-align:center;">最新资讯</h3></div>
	 <div class="row mnd">
	 <?php if(is_array($hot)): $i = 0; $__LIST__ = $hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot): $mod = ($i % 2 );++$i;?><div class="col-md-6 psd wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.3s">
	 	     <div class="content-nien">
	 	    <div class="col-md-3 pic"><img src="/BOXUEYUANEND--double/Public/before/images/121.jpg" alt="" width="100%" class="img-responsive img-circle" ></div>
	 		<div class="col-md-9">
				<h4><?php echo ($hot["title"]); ?></h4>
				 <!--<?php echo (mb_substr($newse["title"],0,10,'utf-8')); ?>...-->
			<p><?php echo (mb_substr($hot["summary"],0,60,'utf-8')); ?>...<br/><span style="margin-left:40%; "><?php echo (mb_substr($hot["updatetime"],0,10,'utf-8')); ?></span></p>
			<br/>
			<a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($hot["id"]); ?>" class="cd-read-more" target="_blank" >阅读全文</a>
		</div>
		</div>
