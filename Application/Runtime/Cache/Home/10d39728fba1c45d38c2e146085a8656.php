...
<div class="row">
     	...
     	<div class="col-md-10">
     		<div class="col-md-6">上一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Chinese/shiti/id/<?php echo ($front["id"]); ?>"><?php echo ($front["zname"]); ?></a></div>
     		<div class="col-md-6">下一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Chinese/shiti/id/<?php echo ($after["id"]); ?>"><?php echo ($after["zname"]); ?></a></div>
     	</div>
     	<div class="col-md-2"></div>
     </div>
...
document.getElementById("btn").onclick = function() {
	...
	// alert(id);
	xhr.open('get', '/BOXUEYUANEND--double/index.php/Home/Chinese/downtest?downid='+id, true);
	xhr.send();
}
</script>
</html>