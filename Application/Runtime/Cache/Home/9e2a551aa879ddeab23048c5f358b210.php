	...
	<div class="row">
		<div class="col-md-12">
			<ul class="breadcrumb">
				...
				<li>
					<a rel="nofollow" href="/BOXUEYUANEND--double/index.php/Home/Hot/hot">热点资讯</a> 
				</li>
				<li class="active">
					资讯内容
				</li>
...
<!--内容-->
	 ...
	 <br>
      ...
      <div class="col-xs-10 col-sm-10 col-md-10">
       <?php if(is_array($hots)): $i = 0; $__LIST__ = $hots;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hotss): $mod = ($i % 2 );++$i;?><div class="row">

      	<div class="col-xs-1 col-sm-1 col-md-1"> </div>
      	<div class="col-xs-10 col-sm-10 col-md-10"><h1 style="text-align:center;"><?php echo ($hotss["title"]); ?></h1>
        <p style="margin-left:8%">时间：<?php echo ($hotss["updatetime"]); ?>&nbsp;&nbsp;&nbsp;来源：<?php echo ($hotss["from"]); ?>&nbsp;&nbsp;&nbsp;作者：<?php echo ($hotss["name"]); ?></p></div>
        <div class="col-xs-1 col-sm-1 col-md-1"> </div>
      </div>
        <hr/>
        <!--试卷部分-->
...
　　    
     ...
     <div class="row">
     	...
     	<div class="col-md-10">
     		<div class="col-md-6">上一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($front["id"]); ?>"><?php echo ($front["title"]); ?></a></div>
     		<div class="col-md-6">下一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($after["id"]); ?>"><?php echo ($after["title"]); ?></a></div>
     	</div>
     	<div class="col-md-2"></div>
     </div>
	  <!--content结束-->
