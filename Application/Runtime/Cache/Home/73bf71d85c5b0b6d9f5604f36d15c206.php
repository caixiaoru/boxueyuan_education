	...
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li>
					<a rel="nofollow" href="/BOXUEYUANEND--double/index.php/Home/GaoKao/gaokaozhuanti">高考专题</a> 
				</li>
				<li class="active">
					高考真题
				</li>
 ...
 <div class="container">
    ...
    <div class="row wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.3s">
      ...
      <div class="col-xs-10 col-sm-10 col-md-10">
      	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="row">
...
<div class="row">
     	...
     	<div class="col-md-10">
     		<div class="col-md-6">上一篇：<a href="/BOXUEYUANEND--double/index.php/Home/GaoKao/zhenti/id/<?php echo ($front["id"]); ?>"><?php echo ($front["zname"]); ?></a></div>
     		<div class="col-md-6">下一篇：<a href="/BOXUEYUANEND--double/index.php/Home/GaoKao/zhenti/id/<?php echo ($after["id"]); ?>"><?php echo ($after["zname"]); ?></a></div>
     	</div>
     	<div class="col-md-2"></div>
     </div>
