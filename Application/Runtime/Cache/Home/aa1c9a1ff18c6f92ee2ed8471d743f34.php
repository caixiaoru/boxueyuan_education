...
<div class="row">
     	...
     	<div class="col-md-10">
     		<div class="col-md-6">上一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Chinese/content/id/<?php echo ($front["zid"]); ?>"><?php echo ($front["dataname"]); ?></a></div>
     		<div class="col-md-6">下一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Chinese/content/id/<?php echo ($after["zid"]); ?>"><?php echo ($after["dataname"]); ?></a></div>
     	</div>
     	<div class="col-md-2"></div>
     </div>
<!--尾部-->
