...
<link href="/BOXUEYUANBI/Public/before/css/footer.css"  rel="stylesheet" type="text/css"/>
<link href="/BOXUEYUANBI/Public/before/css/style1.css" rel="stylesheet" type="text/css" media="all" />
<script src="/BOXUEYUANBI/Public/before/js/wow.min.js"></script> <!--实现页面元素的滚动，需要调用animate.css-->
	<script>
	    //实现页面元素滚动出现的效果
	 	 new WOW().init();
	</script>
...
<body>
<!--导航-->
<div id="home" class="banner w3l" style="background-image: url(/BOXUEYUANBI/Public/before/images/gerenzhongxin.jpg); min-height:400px; ">
    <nav class="navbar navbar-default  wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.3s"style="background: rgb(0,188,212); opacity:0.8;">
                            ...
                            <div class="navbar-header logo">
                                ...
                                <h1>
                                <a class="navbar-brand" href="index.html"><img src="/BOXUEYUANBI/Public/before/images/logo.png" alt="" width="70%"></a>
                                </h1>
                            ...
                            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                                <nav class="cl-effect-1">
                                    <ul class="nav navbar-nav ">
                                       ...
                                       <li><a class="scroll hvr-bounce-to-bottom" href="index.html">首页<p>Home</p></a></li>
                                        
                                        <li><a class="scroll hvr-bounce-to-bottom" href="course.html ">课程天地<p style="text-align: center;"> Course</p></a></li>
                                        <li><a class="scroll hvr-bounce-to-bottom " href="about.html">关于我们<p style="text-align: center;">About us</p></a></li>
                                        <li><a class="scroll hvr-bounce-to-bottom" href="teacher.html">名师团队<p style="text-align: center;">Teacher</p></a></li>
                                        <li><a class="scroll hvr-bounce-to-bottom" href="hot.html">热点资讯 <p style="text-align: center;">News</p></a></li>

                                        <li  id="act-Home"><a class="scroll hvr-bounce-to-bottom" href="#contact">个人中心<p style="text-align: center;">Center</p></a></li>
                                    </ul>
                                </nav>
                            </div><!-- /navbar-collapse -->
    </nav>
...
<div class="container" id="container">
    <div class="row">
        <div class="span12">
            <ul class="breadcrumb">
                <li>
                    <a rel="nofollow" href="index.html">首页</a> <span class="divider"></span>
                </li>
                <li class="active">
                    个人中心
                </li>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-3">
            <div id="picture">
                <div class="tou">
                    <img src="/BOXUEYUANBI/Public/<?php echo ($teacher["img"]); ?>" class="turn" />
                </div>
            </div>
            <ul id="xinxi">
                <li><img src="/BOXUEYUANBI/Public/before/images/user.png" /> 用户名：<?php echo ($teacher["username"]); ?></li>
                <li><img src="/BOXUEYUANBI/Public/before/images/phone.png" /> 联系方式：<?php echo ($teacher["phone"]); ?></li>
                <li><img src="/BOXUEYUANBI/Public/before/images/mailbox.png" /> 邮箱：<?php echo ($teacher["email"]); ?></li>
                <li><img src="/BOXUEYUANBI/Public/before/images/time.png" /> 登录时间：<?php echo (date("y-m-d",strtotime($teacher["registertime"]))); ?></li>
            </ul>
        </div>
		<div class="col-md-9">
			<div class="tabbable">
				<ul class="nav nav-tabs">
                    ...
                    <li>
                        <a rel="nofollow" href="#panel-3" data-toggle="tab">试题下载</a>
                    </li>
                    <li>
                        <a rel="nofollow" href="#panel-4" data-toggle="tab">教材下载</a>
                    </li>
                    <li>
                        <a rel="nofollow" href="#panel-5" data-toggle="tab">视频下载</a>
                    </li>
				</ul>
				<div class="tab-content">
					...
					<div class="tab-pane wow zoomIn" id="panel-2" data-wow-duration="1.5s" data-wow-delay="0s">
						<form role="form" action="/BOXUEYUANBI/index.php/Home/person/doAdd" method="post" enctype="multipart/form-data" class="ttop">
                           <table id="twidth">
                            <tr>
                                <td>科&nbsp;&nbsp;目:<span>*</span></td>
                                <td>&nbsp;</td>
