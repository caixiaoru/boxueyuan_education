...
<link href="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/css/animate.css" rel="stylesheet" type="text/css" media="all">
<link href="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/css/footer.css"  rel="stylesheet" type="text/css"/>
<link href="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/css/style1.css" rel="stylesheet" type="text/css" media="all" />
<script src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/js/wow.min.js"></script> <!--实现页面元素的滚动，需要调用animate.css-->
	<script>
	    //实现页面元素滚动出现的效果
	 	 new WOW().init(); 
	</script> 
...
<body>
<!--导航-->
<div id="home" class="banner w3l" style="background-image: url(/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/images/gerenzhongxin.jpg); min-height:400px; ">
                                ...
                                <nav class="cl-effect-1">
                                    <ul class="nav navbar-nav ">
                                       ...
                                       <li><a class="scroll hvr-bounce-to-bottom" href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Index/indexlogin">首页<p>Home</p></a></li>
                                        ...
                                        <li><a class="scroll hvr-bounce-to-bottom" href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Course/course">课程天地<p style="text-align: center;"> Course</p></a></li>
                                        ...
                                        <li id="act-Home"><a class="scroll hvr-bounce-to-bottom" href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Person/person">个人中心<p style="text-align: center;">Center</p></a></li><li><a class="hvr-bounce-to-bottom " href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/person/logout" >退出<p >Logout</p></a></li>
                                    </ul>
                                </nav>
                            </div><!-- /navbar-collapse -->
    </nav>
...
<div class="container" id="container">
    <div class="row">
        <div class="span12">
            <ul class="breadcrumb">
                <li>
                    <a rel="nofollow" href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Index/indexlogin">首页</a> <span class="divider"></span>
                </li>
                <li>
                    <a rel="nofollow" href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Person/person">个人中心</a> <span class="divider"></span>
                </li>
                <li class="active">
                    修改信息
                </li>
	        ...
	        <form method="post" action="" enctype="multipart/form-data">
                <table class="ttop">
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td><input type="text" name="username" id="admin-username" value="<?php echo ($teacher["username"]); ?>" readonly></td>
                    </tr>
                    <tr>
                        <td>密&nbsp;&nbsp;码:<span class="nei">*</span></td>
                        <td>&nbsp;</td>
                        <td><input type="password" name="password" id="admin-password" value="<?php echo ($teacher["password"]); ?>"></td>
                    </tr>
                    <tr>
                        <td>确认密码:<span class="nei">*</span></td>
                        <td>&nbsp;</td>
                        <td><input type="password" name="repassword" id="admin-repassword" value="<?php echo ($teacher["password"]); ?>"></td>
                    </tr>
                    <tr>
                        <td>手机号码:<span>&nbsp;</span></td>
                        <td>&nbsp;</td>
                        <td><input type="number" name="phone" id="admin-phone" value="<?php echo ($teacher["phone"]); ?>"></td>
                    </tr>
                    <tr>
                        <td>电子邮箱:<span class="nei">*</span></td>
                        <td>&nbsp;</td>
                        <td><input type="email" name="email" id="admin-email" value="<?php echo ($teacher["email"]); ?>"></td>
                    </tr>

                    <tr>
                        <td>注册时间:<span>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td><input type="data" name="registertime" id="admin-time" value="<?php echo ($teacher["registertime"]); ?>" readonly></td>
                    </tr>

                    <tr>
                        <td>头&nbsp;&nbsp;像:<span class="nei">*</span></td>
                        <td>&nbsp;</td>
                        <td><img src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/<?php echo ($teacher["img"]); ?>"  width="80px" height="80px"/><input type="file" name="img" id="admin-img"></td>
                    </tr>
...
<script type="text/javascript" src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/js/jquery-2.1.4.min.js"></script>
<script type="text/javascript" src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/js/bootstrap-3.1.1.min.js"></script>
</body>
</html>