    ...
    <div class="col-xs-3 col-sm-3 col-md-3 column">
      <div class="list-group">
        ...
        <div class="list-group-item active">
          <a href="/BOXUEYUAN/index.php/Home/WenZong/jiaocaitongbu.html"><h4 style="text-align:center;color:black;">教材同步</h4></a>
        </div>
        <div class="list-group-item">
           <a href="/BOXUEYUAN/index.php/Home/WenZong/gaokaomoni.html"><h4 style="text-align:center;color:black;">高考模拟</h4></a>
        </div> 
        <div class="list-group-item">
           <a href="/BOXUEYUAN/index.php/Home/WenZong/beikaocelue.html"><h4 style="text-align:center;color:black;">备考策略</h4></a>
        </div>
        <div class="list-group-item">
           <a href="/BOXUEYUAN/index.php/Home/WenZong/gaokaozhenti.html"><h4 style="text-align:center;color:black;">高考真题</h4></a>
        </div>
      </div>
    </div>
    <!--教材-->
