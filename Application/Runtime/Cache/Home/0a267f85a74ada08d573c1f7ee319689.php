							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								<nav class="cl-effect-1">
									<ul class="nav navbar-nav ">
										...
										<li id="act-Home"><a class="scroll hvr-bounce-to-bottom active" href="" style="width:75px">首页<p>Home</p></a></li>
										...
										<li><a class="hvr-bounce-to-bottom" href="/BOXUEYUANEND--double/index.php/Home/person/person">个人中心<p style="text-align: center;">Center</p></a></li>
...
<div id="gallery" class="gallery all_pad wthree" style="margin-top:2%;">
	<div class="container">  <h3 class="title"><a href="/BOXUEYUANEND--double/index.php/Home/course/course">课程天地</a></h3> 
			...
			<div class="col-md-4 gal-grid  wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="gal-img">
					...
					<div class="view-pos" ><h4 style="border-radius: 8px;"><a href="/BOXUEYUANEND--double/index.php/Home/Chinese/chinese">点击进入</a></h4></div>
					<p>教材、资料、视频任你挑</p>
				</div>
			</div>
			<div class="col-md-4 gal-grid  wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="gal-img">
					...
					<div class="view-pos"><h4 style="border-radius: 8px;"><a href="/BOXUEYUANEND--double/index.php/Home/Math/math">点击进入</a></h4></div>
					<p>教材、资料、视频任你挑</p>
				</div>
			</div>
			<div class="col-md-4 gal-grid wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="gal-img">
					...
					<div class="view-pos"><h4 style="border-radius: 8px;"><a href="/BOXUEYUANEND--double/index.php/Home/English/english">点击进入</a></h4></div>
					<p>教材、资料、视频任你挑</p>
				</div>
			</div>
			<div class="col-md-4 gal-grid gal-top wow bounceInDown" data-wow-duration="1.5s" data-wow-delay="0.3s">
				<div class="gal-img">
					...
					<div class="view-pos"><h4 style="border-radius: 8px;"><a href="/BOXUEYUANEND--double/index.php/Home/Lizong/lizong">点击进入</a></h4></div>
					<p>教材、资料、视频任你挑</p>
				</div>
			</div>
			<div class="col-md-4 gal-grid gal-top wow bounceInDown" data-wow-duration="1.5s" data-wow-delay="0.3s">
				<div class="gal-img">
					...
					<div class="view-pos"><h4 style="border-radius: 8px;"><a href="/BOXUEYUANEND--double/index.php/Home/Wenzong/wenzong">点击进入</a></h4></div>
					<p>教材、资料、视频任你挑</p>
				</div>
			</div>
			<div class="col-md-4 gal-grid gal-top wow bounceInDown" data-wow-duration="1.5s" data-wow-delay="0.3s">
				<div class="gal-img">
					...
					<div class="view-pos"><h4 style="border-radius: 8px;"><a href="/BOXUEYUANEND--double/index.php/Home/GaoKao/gaokaozhuanti">点击进入</a></h4></div>
					<p>高考真题应有尽有</p>
				</div>
			</div>
...
<div id="about" class="about all_pad agile" style="margin-top:5%;padding-top:5%;padding-bottom:5%">
	<div class="container">
		<h3 class="title1"><a href="/BOXUEYUANEND--double/index.php/Home/about/about">关于我们</a></h3>
...
<div id="team" class="team-content all_pad w3agile" style="margin-top:2%;">
	<div class="container">
		<h3 class="title"><a href="/BOXUEYUANEND--double/index.php/Home/teacher/teacher">名师团队</a></h3>
		...
		<?php if(is_array($tc)): $i = 0; $__LIST__ = $tc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tc): $mod = ($i % 2 );++$i;?><div class="col-md-3 t-cont-gds wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="team-img">
					...
					<div class="team-text">
						<h4 style="text-align:center;"><a href="/BOXUEYUANEND--double/index.php/Home/Teacher/teacher_content/Tid/<?php echo ($tc["tid"]); ?>"><?php echo ($tc["username"]); ?></a><span>教授</span></h4>
	...
	<div class="container">
		...
		<?php if(is_array($tcc)): $i = 0; $__LIST__ = $tcc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tcc): $mod = ($i % 2 );++$i;?><div class="col-md-3 t-cont-gds wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="team-img">
					...
					<div class="team-text">
						<h4 style="text-align:center;"><a href="/BOXUEYUANEND--double/index.php/Home/Teacher/teacher_content/Tid/<?php echo ($tcc["tid"]); ?>"><?php echo ($tcc["username"]); ?></a><span>教授</span></h4>
					<p style="text-align:center;">欢迎指数:<img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"><img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"><img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"></p>
			...
			<!--<div class="col-md-3 t-cont-gds wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="team-img">
					<img class="img-responsive" src="/BOXUEYUANEND--double/Public/before/images\teacher-3.jpg" alt=" "/>
					<div class="team-text">
						<h4><a href="teacher-content.html">张老师</a><span>教授</span></h4>
					<p>欢迎指数:<img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"><img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"><img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"></p>
			...
			<div class="col-md-3 t-cont-gds wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="team-img">
					<img class="img-responsive" src="/BOXUEYUANEND--double/Public/before/images/team3.jpg" alt=" "/>
					<div class="team-text">
						<h4><a href="teacher-content.html">张老师</a><span>教授</span></h4>
					<p>欢迎指数:<img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"><img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"><img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"></p>
						<p><span style="color: #00bcd4">英国语言学学士</span>，美国亚利桑那大学毕业(PIAOJINHUI University)，原新东方特级讲师，培训师，著有《朴槿惠》</p>
			...
			<div class="col-md-3 t-cont-gds wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="team-img">
					<img class="img-responsive" src="/BOXUEYUANEND--double/Public/before/images/team1.jpg" alt=" "/>
					<div class="team-text">
						<h4><a href="teacher-content.html">张老师</a><span>教授</span></h4>
					<p>欢迎指数:<img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"><img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"><img src='/BOXUEYUANEND--double/Public/before/images/2.png' style="vertical-align: 0%"></p>
						<p><span style="color: #00bcd4">英国语言学学士</span>，美国亚利桑那大学毕业(PIAOJINHUI University)，原新东方特级讲师，培训师，著有《朴槿惠》</p>
...
<!-- *************************************************************************************************************************** -->
<h1 style="text-align: center;padding: 30px;"><a href="/BOXUEYUANEND--double/index.php/Home/hot/hot" style="color:#000">热点资讯</a></h1>
<div class="soft_function" id="news">
	...
	<div class="soft_con">
		...
		<?php if(is_array($kaosheng)): $i = 0; $__LIST__ = $kaosheng;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$kaosheng): $mod = ($i % 2 );++$i;?><div class="function1">
				<a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($kaosheng["id"]); ?>"><img src="/BOXUEYUANEND--double/Public/<?php echo ($kaosheng["thumb"]); ?>"/ width="150px;"></a>
				<p class="p1"><a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($kaosheng["id"]); ?>"><?php echo ($kaosheng["title"]); ?></a></p>
		...
		<?php if(is_array($tigang)): $i = 0; $__LIST__ = $tigang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tigang): $mod = ($i % 2 );++$i;?><div class="function1">
					<a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($tigang["id"]); ?>"><img src="/BOXUEYUANEND--double/Public/<?php echo ($tigang["thumb"]); ?>"/ width="150px;"></a>
				<p class="p1"><a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($tigang["id"]); ?>"><?php echo ($tigang["title"]); ?></a></p>
		...
		<?php if(is_array($zhiyuan)): $i = 0; $__LIST__ = $zhiyuan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zhiyuan): $mod = ($i % 2 );++$i;?><div class="function1">
					<a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($zhiyuan["id"]); ?>"><img src="/BOXUEYUANEND--double/Public/<?php echo ($zhiyuan["thumb"]); ?>"/ width="150px;"></a>
				<p class="p1"><a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($zhiyuan["id"]); ?>"><?php echo ($zhiyuan["title"]); ?></a></p>
		...
		<?php if(is_array($xueke)): $i = 0; $__LIST__ = $xueke;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xueke): $mod = ($i % 2 );++$i;?><div class="function1">
					<a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($xueke["id"]); ?>"><img src="/BOXUEYUANEND--double/Public/<?php echo ($xueke["thumb"]); ?>"/ width="150px;"></a>
				<p class="p1"><a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($xueke["id"]); ?>"><?php echo ($xueke["title"]); ?></a></p>
		...
		<?php if(is_array($jiaoyubu)): $i = 0; $__LIST__ = $jiaoyubu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jiaoyubu): $mod = ($i % 2 );++$i;?><div class="function1">
					 <a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($jiaoyubu["id"]); ?>"><img src="/BOXUEYUANEND--double/Public/<?php echo ($jiaoyubu["thumb"]); ?>"/ width="150px;"></a>
				<p class="p1"><a href="/BOXUEYUANEND--double/index.php/Home/Hot/hot_content/id/<?php echo ($jiaoyubu["id"]); ?>"><?php echo ($jiaoyubu["title"]); ?></a></p>
