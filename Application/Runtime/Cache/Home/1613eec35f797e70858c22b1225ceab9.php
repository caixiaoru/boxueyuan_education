...
<div class="container" id="container">
  ...
  <div class="container">
		 ...
		 <div class="row">
		  ...
		  <br>
			<div class="col-md-12 column" style="border-bottom:1px dashed black;">
              <div id="hd">
               <img src="/BOXUEYUANEND--double/Public/before/images//english.png" width="5%"/>更新于&nbsp;&nbsp;<?php echo ($data["addtime"]); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo ($abc['viewcount']); ?>人阅读&nbsp;&nbsp;教材同步
              </div>
            </div>
   ...
   <button type="submit" class="btn btn-primary" id="btn" value="<?php echo ($data["zid"]); ?>"><a href="/BOXUEYUANEND--double/Public/before/english.docx" >下载文档</a></button>
...
<div class="row">
     	...
     	<div class="col-md-10">
     		<div class="col-md-6">上一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Lizong/content/id/<?php echo ($front["zid"]); ?>"><?php echo ($front["dataname"]); ?></a></div>
     		<div class="col-md-6">下一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Lizong/content/id/<?php echo ($after["zid"]); ?>"><?php echo ($after["dataname"]); ?></a></div>
     	</div>
     	<div class="col-md-2"></div>
     </div>
<!--尾部-->
...
document.getElementById("btn").onclick = function() {
	...
	//alert(id);
	xhr.open('get', '/BOXUEYUANEND--double/index.php/Home/Lizong/downjiaocai?downid='+id, true);
	xhr.send();
}
