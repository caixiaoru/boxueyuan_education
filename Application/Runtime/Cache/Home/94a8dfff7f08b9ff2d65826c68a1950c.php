	...
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li>
					<a rel="nofollow" href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Math/Math">数学</a>
				</li>
				<li class="active">
					教材
				</li>
...
<div class="row clearfix">
		<div class="col-md-12 column">
			<div class="row clearfix">
				...
				<div class="col-md-5 column"> <!--<a id="modal-171610" href="tencent://message/?uin=2918535608 " role="button" class="btn" style="background-color:rgb(0,188,212);color:white;text-decoration:none;width:25%;"><img src="/BOXUEYYUAN/a/a/BOXUEYUANEND/Public/before/images/QQ.jpg" alt="" width="15%">&nbsp;联系我们</a>-->
				 <a href="tencent://message/?uin=2918535608" class="btn btn-primary btn-large" href="#">开始聊天</a>
...
<div class="container" id="con">
	<div class="row clearfix">
	 ...
	 <?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$datas): $mod = ($i % 2 );++$i;?><div class="col-md-3 column">
			...
			<br>
			<br>
			<p style="text-align:center;"><button type="button" class="btn btn-default btn-danger"><a href="/BOXUEYYUAN/a/a/BOXUEYUANEND/index.php/Home/Lizong/newbuy/id/<?php echo ($datas["zid"]); ?>" style="color:white;">购买</a></button></p>
