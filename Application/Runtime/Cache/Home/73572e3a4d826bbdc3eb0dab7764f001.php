...
<script src="/BOXUEYUANEND--double/Public/before/js/wow.min.js"></script>
	<script> 
	  ...
	  <script type="text/javascript" src="/BOXUEYUANEND--double/Public/before/js/jquery-1.8.3.min.js"></script>
        ...
        <style type="text/css">
           ...
           .shang_payimg{width:140px;padding:10px;margin:0 auto;border-radius:3px;height:140px;}
            ...
            .radiobox{width: 16px;height: 16px;background: url('/BOXUEYUANEND--double/Public/before/images/radio2.jpg');display: block;float: left;margin-top: 5px;margin-right: 14px;}
            .checked .radiobox{background:url('/BOXUEYUANEND--double/Public/before/images/radio1.jpg');}
...
<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row clearfix">
				<div class="col-md-2 column">
					<img alt="140x140" src="/BOXUEYUANEND--double/Public/<?php echo ($data["thumb"]); ?>" width="100%"/>
				</div>
     ...
     $("#cont").val(window.count);
      if(window.count<=1){
		...
		<div class="col-md-4 column">
            ...
            <div class="shang_box">
                <a class="shang_close" href="javascript:void(0)" onclick="dashangToggle()" title="关闭"><img src="/BOXUEYUANEND--double/Public/before/images/close.jpg" alt="取消" /></a>
                <div class="shang_tit">
                    <p>感谢您的支持，我会继续努力的!</p>
                </div>
                <div class="shang_payimg">
                    <img src="/BOXUEYUANEND--double/Public/before/images/alipayimg.jpg" alt="扫码支持" title="扫一扫" />
               ...
               <!--  <div class="pay_explain">扫码支付，您需要支付<span style="color:red;font-size:2em;"><script>document.write(String(window.zong))</script></span>元</div> -->
                <div class="shang_payselect">
                    <div class="pay_item checked" data-id="alipay">
                        ...
                        <span class="pay_logo"><img src="/BOXUEYUANEND--double/Public/before/images/alipay.jpg" alt="支付宝" /></span>
                    </div>
                    <div class="pay_item" data-id="weipay">
                        <span class="radiobox"></span>
                        <span class="pay_logo"><img src="/BOXUEYUANEND--double/Public/before/images/wechat.jpg" alt="微信" /></span>
                    </div>
                </div>
...
<div class="container" id="con">
	<div class="row clearfix">
	 ...
	 <?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$datas): $mod = ($i % 2 );++$i;?><div class="col-md-3 column">
			<img alt="140x140" src="/BOXUEYUANEND--double/Public/<?php echo ($datas["thumb"]); ?>" /> 
			<br>
			<br>
			<p style="text-align:center;"><button type="button" class="btn btn-default btn-danger"><a href="/BOXUEYUANEND--double/index.php/Home/Lizong/newbuy/id/<?php echo ($datas["zid"]); ?>" style="color:white">购买</a></button></p>
...
<script type="text/javascript">
            $(function() {
                $(".pay_item").click(function() {
                    ...
                    $(".shang_payimg img").attr("src", "/BOXUEYUANEND--double/Public/before/images/" + dataid + "img.jpg");
