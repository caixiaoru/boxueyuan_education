...
<!---->
<div id="team" class="team-content all_pad w3agile" style="margin-top:-10%">
	<div class="container">
		<h3 class="title">名师团队</h3>
		<div class="t-content-gds">
		<?php if(is_array($tea)): $i = 0; $__LIST__ = $tea;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tea): $mod = ($i % 2 );++$i;?><div class="col-md-3 t-cont-gds wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0s" style="margin-top:2%;">
				<div class="team-img">
					<img class="img-responsive" src="/BOXUEYUANEND--double/Public/<?php echo ($tea["img"]); ?>" alt=" "/>
					<div class="team-text">
						<h4><a href="/BOXUEYUANEND--double/index.php/Home/Teacher/teacher_content/Tid/<?php echo ($tea["tid"]); ?>"><?php echo ($tea["username"]); ?></a><span>教授</span></h4>
					
						<p>美国亚利桑那大学毕业(PIAOJINHUI University)，原新东方特级讲师，培训师，著有《朴槿惠》</p>
