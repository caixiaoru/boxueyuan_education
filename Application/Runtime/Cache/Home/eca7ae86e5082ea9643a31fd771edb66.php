...
<div class="container">
	<div class="row">
		...
		<div class="col-xs-3 col-sm-3 col-md-3">
		    <div id="picture">
			    <div class="tou">
				    <img src="/BOXUEYUANEND--double/Public/<?php echo ($user["img"]); ?>" class="turn" />
			    </div>
			</div>
			<ul id="xinxi">
				<li><img src="/BOXUEYUANEND--double/Public/before/images/user.png" /> 用户名：<p>&nbsp;&nbsp;&nbsp;<?php echo ($user["username"]); ?></p></li>
				<li><img src="/BOXUEYUANEND--double/Public/before/images/phone.png" /> 联系方式：<p>&nbsp;&nbsp;&nbsp;<?php echo ($user["phone"]); ?></p></li>
				<li><img src="/BOXUEYUANEND--double/Public/before/images/mailbox.png" /> 邮箱：<p>&nbsp;&nbsp;&nbsp;<?php echo ($user["email"]); ?></p></li>
				<li><img src="/BOXUEYUANEND--double/Public/before/images/time.png" /> 注册时间：<p>&nbsp;&nbsp;&nbsp;<?php echo (date("Y-m-d",strtotime($user["registertime"]))); ?></p></li>
			</ul>
            <div style="margin-top:5%">
                <img src="/BOXUEYUANEND--double/Public/before/images/editp.png" /><a href="/BOXUEYUANEND--double/index.php/Home/person/edit_student/id/<?php echo ($user["sid"]); ?>" class="btn" />修改个人信息</a>
            </div>
		</div>
		<div class="col-xs-9 col-sm-9 col-md-9">
			<div class="tabbable">
				<ul class="nav nav-tabs">
					<li class="active">
                        <a rel="nofollow" href="#panel-1" data-toggle="tab">试题下载记录</a>
                    </li>
                   <!-- <li>
                        <a rel="nofollow" href="#panel-2" data-toggle="tab">教材下载记录</a>
                    </li>-->
                    <!--<li>
                        <a rel="nofollow" href="#panel-3" data-toggle="tab">视频下载记录</a>
                    </li>-->
				</ul>
				<div class="tab-content">
                    ...
                    <!--<div class="tab-pane wow bounceInUp" id="panel-2"  data-wow-duration="1.5s" data-wow-delay="0s">
                        <table class="table ttop">
                            <tr>
                                <td>教材名称</td>
                                <td>年级</td>
