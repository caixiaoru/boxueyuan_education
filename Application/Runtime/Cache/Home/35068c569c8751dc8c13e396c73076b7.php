...
#shangyi a{
	...
	<link rel="stylesheet" type="text/css" href="/BOXUEYUANEND--double/Public/before/css/new1.css" media="all"/>
							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								<nav class="cl-effect-1">
									<ul class="nav navbar-nav ">
									    ...
									    <li id="act-Home"><a class="scroll hvr-bounce-to-bottom active" href="/BOXUEYUANEND--double/index.php/Home/Teacher/teacher">名师团队<p style="text-align: center;">Teacher</p></a></li>
  ...
  <div class="row clearfix" >
    ...
    <div class="col-md-12 column">
       <ul class="breadcrumb">
                      ...
                      <li>
                        <a rel="nofollow" href="/BOXUEYUANEND--double/index.php/Home/Teacher/teacher">名师团队</a>
                      </li>
...
<br/>
<div class="container">
  <?php if(is_array($teachers)): $i = 0; $__LIST__ = $teachers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$teachers): $mod = ($i % 2 );++$i;?><p style="text-align:center"><img src="/BOXUEYUANEND--double/Public/before/images/xian.png" alt="" widtn="80%"></p>
<br>
  <div class="row clearfix">
   <div class="col-md-1 " >
    ...
    <div class="row">
      <div class="col-md-3 column"><img src="/BOXUEYUANEND--double/Public/<?php echo ($teachers["img"]); ?>" class="img-rounded" width="100%"/></div>
      <div class="col-md-9 column">
      <dl>
        <dt style="font-size:2em;">
        <?php echo ($teachers["username"]); ?>
        </dt>
        <dd style="font-size:1.3em;text-indent:2em;line-height:1.5em;">
        <?php echo ($teachers["summary"]); ?>
 ...
 <div class="row">
     	...
     	<div class="col-md-10" id="shangyi">
     		<div class="col-md-6">上一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Teacher/teacher_content/Tid/<?php echo ($front["tid"]); ?>"><?php echo ($front["username"]); ?>教授</a></div>
     		<div class="col-md-6">下一篇：<a href="/BOXUEYUANEND--double/index.php/Home/Teacher/teacher_content/Tid/<?php echo ($after["tid"]); ?>"><?php echo ($after["username"]); ?>教授</a></div>
     	</div>
     	<div class="col-md-2"></div>
     </div>
     <!--尾部-->
     <div class="copy-right" style="background-color: rgb(50,56,60);margin-top:5%;">
	<div class="container">
		<div class="row clearfix">
