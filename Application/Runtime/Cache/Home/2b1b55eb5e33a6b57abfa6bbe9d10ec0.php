...
<div id="home" class="banner w3l" style="background-image: url(/BOXUEYUANEND--double/Public/before/images/高考3.jpg); min-height:400px; ">
		...
		<nav class="navbar navbar-default  wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.3s" style="background: rgba(0,188,212,0.6);">
							...
							<div class="navbar-header logo">
								...
								<h1>
								<a class="navbar-brand" href="#"><img src="/BOXUEYUANEND--double/Public/before/images/logo.png" alt="" width="70%" style="margin-top:-10%"></a>
								</h1>
...
<div class="container">
	 <div class="row">
	 	 <div class="col-md-12 column">
             <ul class="breadcrumb">
            <li>
              <a href="/BOXUEYUANEND--double/index.php/Home/index/indexlogin">首页</a>
            </li>
	 ...
	 <div class="container container-hot wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.3s">
	 <div class="row "><h3 style="text-align:center;">课程天地</h3></div>
	 <div class="row mnd">
	 	<div class="col-md-1 "></div>
	 	<div class="col-md-4 psd wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.3s">
	 	     <div class="content-nien">
