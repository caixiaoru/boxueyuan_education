...
class LizongController extends Controller {
     public function lizong(){
     	$dataModel = M("data");
     	$data = $dataModel->where('subject="物理" AND grade="高一"')->limit(4)->select();
     	// var_dump($data);exit;
     	$this->assign("data",$data);

     	// $data = $dataModel->where('subject="物理" OR subject="化学" OR subject="生物" ')->limit(4)->select();
     	$data1 = $dataModel->where('subject="生物" AND grade="高一"')->limit(4)->select();
     	$this->assign("data1",$data1);
     	$data2 = $dataModel->where('subject="化学" AND grade="高一"')->limit(4)->select();
     	...
     	$video1Model = M("video");
        $video1 = $video1Model->join('teacher on video.Tid = teacher.Tid')->where('subject="物理" AND grade="高一"')->limit(4)->select();
        $this->assign("video1",$video1);

        $video1Model2 = M("video");
        $video2 = $video1Model2->join('teacher on video.Tid = teacher.Tid')->where('subject="化学" AND grade="高一"')->limit(4)->select();
        $this->assign("video2",$video2);

        $video1Model3 = M("video");
        $video3 = $video1Model3->join('teacher on video.Tid = teacher.Tid')->where('subject="生物" AND grade="高一"')->limit(4)->select();
        $this->assign("video3",$video3);


     	$data3 = $dataModel->where('subject="物理" AND grade="高二"')->limit(4)->select();
     	// var_dump($data);exit;
     	$this->assign("data3",$data3);

     	// $data = $dataModel->where('subject="物理" OR subject="化学" OR subject="生物" ')->limit(4)->select();
     	$data4 = $dataModel->where('subject="化学" AND grade="高二"')->limit(4)->select();
     	$this->assign("data4",$data4);
     	$data5 = $dataModel->where('subject="生物" AND grade="高二"')->limit(4)->select();
     	$this->assign("data5",$data5);

     	$video4Model = M("video");
        $video4 = $video4Model->join('teacher on video.Tid = teacher.Tid')->where('subject="物理" AND grade="高二"')->limit(4)->select();
        // var_dump($video4);exit;
        $this->assign("video4",$video4);

        $video1Model5 = M("video");
        $video5 = $video1Model5->join('teacher on video.Tid = teacher.Tid')->where('subject="化学" AND grade="高二"')->limit(4)->select();
        $this->assign("video5",$video5);

        $video1Model6 = M("video");
        $video6 = $video1Model6->join('teacher on video.Tid = teacher.Tid')->where('subject="生物" AND grade="高二"')->limit(4)->select();
        $this->assign("video6",$video6);
        
        $data6 = $dataModel->where('subject="物理" AND grade="高三"')->limit(4)->select();
     	// var_dump($data);exit;
     	$this->assign("data6",$data6);

     	// $data = $dataModel->where('subject="物理" OR subject="化学" OR subject="生物" ')->limit(4)->select();
     	$data7 = $dataModel->where('subject="化学" AND grade="高三"')->limit(4)->select();
     	$this->assign("data7",$data7);
     	$data8 = $dataModel->where('subject="生物" AND grade="高三"')->limit(4)->select();
     	$this->assign("data8",$data8);


     	$video7Model = M("video");
        $video7 = $video7Model->join('teacher on video.Tid = teacher.Tid')->where('subject="物理" AND grade="高三"')->limit(4)->select();
        // var_dump($video4);exit;
        $this->assign("video7",$video7);

        $video8Model = M("video");
        $video8 = $video8Model->join('teacher on video.Tid = teacher.Tid')->where('subject="化学" AND grade="高三"')->limit(4)->select();
        $this->assign("video8",$video8);

        $video9Model = M("video");
        $video9 = $video9Model->join('teacher on video.Tid = teacher.Tid')->where('subject="生物" AND grade="高三"')->limit(4)->select();
        ...
        if($_GET['downid']){
            ...
            $id = $_GET['downid'];
             ...
             if($identity == 'teacher'){
                ...
                $tid = $teacherModel->where("username='%s'",$teachername)->getField('tid');
                $data['Tdownid']=$tid;
                $downModel->add($data);
            }
